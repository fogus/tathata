...
## <a name="fogus.tathata/fetch">`fetch`</a>
``` clojure
...
<p><sub><a href="https://github.com/fogus/tathata/blob/main/src/clj/fogus/tathata.clj#L42-L49">Source</a></sub></p>

## <a name="fogus.tathata/guarded">`guarded`</a>
``` clojure
...
<p><sub><a href="https://github.com/fogus/tathata/blob/main/src/clj/fogus/tathata.clj#L62-L78">Source</a></sub></p>

## <a name="fogus.tathata/nothing">`nothing`</a>



<p><sub><a href="https://github.com/fogus/tathata/blob/main/src/clj/fogus/tathata.clj#L29-L29">Source</a></sub></p>

## <a name="fogus.tathata/pod">`pod`</a>
``` clojure
...
Takes an object and a policy and returns an object having `Suchness`,
   ...
   instance.
<p><sub><a href="https://github.com/fogus/tathata/blob/main/src/clj/fogus/tathata.clj#L51-L60">Source</a></sub></p>

## <a name="fogus.tathata/via">`via`</a>
``` clojure
...
Calls a method or function `op` through the given [`pod`](#fogus.tathata/pod) with
   ...
   pod and guarded / coordinated by the pod's policy.
<p><sub><a href="https://github.com/fogus/tathata/blob/main/src/clj/fogus/tathata.clj#L31-L40">Source</a></sub></p>
...
This namespace defines the particulars of a specific kind of
   ...
   Clojure's transients.  That is, a [`GeneralPod`](#fogus.tathata.impl.general-pod/generalpod) provides the
   ...
   The [`GeneralPod`](#fogus.tathata.impl.general-pod/generalpod) type should be considered as:
...
## <a name="fogus.tathata.impl.general-pod/->generalpod">`->GeneralPod`</a>
``` clojure

(->GeneralPod policy val ephemeron _meta)
```
Function.
<p><sub><a href="https://github.com/fogus/tathata/blob/main/src/clj/fogus/tathata/impl/general_pod.clj#L33-L86">Source</a></sub></p>
...
## <a name="fogus.tathata.policies/*in-pods*">`*in-pods*`</a>



<p><sub><a href="https://github.com/fogus/tathata/blob/main/src/clj/fogus/tathata/policies.clj#L74-L74">Source</a></sub></p>
...
## <a name="fogus.tathata.protocols/axiomatic">`Axiomatic`</a>
...
<p><sub><a href="https://github.com/fogus/tathata/blob/main/src/clj/fogus/tathata/protocols.clj#L42-L52">Source</a></sub></p>

## <a name="fogus.tathata.protocols/coordinator">`Coordinator`</a>
...
<p><sub><a href="https://github.com/fogus/tathata/blob/main/src/clj/fogus/tathata/protocols.clj#L68-L87">Source</a></sub></p>

## <a name="fogus.tathata.protocols/sentry">`Sentry`</a>
...
<p><sub><a href="https://github.com/fogus/tathata/blob/main/src/clj/fogus/tathata/protocols.clj#L54-L66">Source</a></sub></p>

## <a name="fogus.tathata.protocols/suchness">`Suchness`</a>
...
<p><sub><a href="https://github.com/fogus/tathata/blob/main/src/clj/fogus/tathata/protocols.clj#L89-L116">Source</a></sub></p>

## <a name="fogus.tathata.protocols/tomutable">`ToMutable`</a>
...
<p><sub><a href="https://github.com/fogus/tathata/blob/main/src/clj/fogus/tathata/protocols.clj#L21-L27">Source</a></sub></p>

## <a name="fogus.tathata.protocols/tovalue">`ToValue`</a>
...
<p><sub><a href="https://github.com/fogus/tathata/blob/main/src/clj/fogus/tathata/protocols.clj#L29-L40">Source</a></sub></p>

## <a name="fogus.tathata.protocols/compare-pod">`compare-pod`</a>
``` clojure
...
<p><sub><a href="https://github.com/fogus/tathata/blob/main/src/clj/fogus/tathata/protocols.clj#L63-L66">Source</a></sub></p>

## <a name="fogus.tathata.protocols/coordinate">`coordinate`</a>
``` clojure
...
This function is meant to coordinate the access of more than
    one pod. The [`coordinate`](#fogus.tathata.protocols/coordinate) implementation will receive a function
    `fun` and a sequence of `pods`.  The pods in the sequence should
    be given as arguments to the given function. It's left to the
    specific implementations of [`coordinate`](#fogus.tathata.protocols/coordinate) to define if the `pods`
    ...
    requirement.
<p><sub><a href="https://github.com/fogus/tathata/blob/main/src/clj/fogus/tathata/protocols.clj#L79-L87">Source</a></sub></p>

## <a name="fogus.tathata.protocols/get-ephemeron">`get-ephemeron`</a>
``` clojure
...
Given a `pod`, this function is expected to return the mutable
    ...
    appropriate.
<p><sub><a href="https://github.com/fogus/tathata/blob/main/src/clj/fogus/tathata/protocols.clj#L96-L101">Source</a></sub></p>

## <a name="fogus.tathata.protocols/guard">`guard`</a>
``` clojure
...
This function is meant to encapsulate the access logic for a
    single pod. It's conceivable that the [`guard`](#fogus.tathata.protocols/guard) logic might be
    constituent to the coordination logic around multiple pods,
    but this is not a requirement. [`guard`](#fogus.tathata.protocols/guard) will receive a function
    `fun` that is meant to receive the `pod` as its only argument.
<p><sub><a href="https://github.com/fogus/tathata/blob/main/src/clj/fogus/tathata/protocols.clj#L73-L78">Source</a></sub></p>

## <a name="fogus.tathata.protocols/make-pod">`make-pod`</a>
``` clojure
...
<p><sub><a href="https://github.com/fogus/tathata/blob/main/src/clj/fogus/tathata/protocols.clj#L59-L62">Source</a></sub></p>

## <a name="fogus.tathata.protocols/mutable->value">`mutable->value`</a>
``` clojure
...
<p><sub><a href="https://github.com/fogus/tathata/blob/main/src/clj/fogus/tathata/protocols.clj#L35-L40">Source</a></sub></p>

## <a name="fogus.tathata.protocols/mutant?">`mutant?`</a>
``` clojure
...
<p><sub><a href="https://github.com/fogus/tathata/blob/main/src/clj/fogus/tathata/protocols.clj#L114-L116">Source</a></sub></p>

## <a name="fogus.tathata.protocols/precept-get">`precept-get`</a>
``` clojure
...
<p><sub><a href="https://github.com/fogus/tathata/blob/main/src/clj/fogus/tathata/protocols.clj#L47-L48">Source</a></sub></p>

## <a name="fogus.tathata.protocols/precept-render">`precept-render`</a>
``` clojure
...
<p><sub><a href="https://github.com/fogus/tathata/blob/main/src/clj/fogus/tathata/protocols.clj#L51-L52">Source</a></sub></p>

## <a name="fogus.tathata.protocols/precept-set">`precept-set`</a>
``` clojure
...
<p><sub><a href="https://github.com/fogus/tathata/blob/main/src/clj/fogus/tathata/protocols.clj#L49-L50">Source</a></sub></p>

## <a name="fogus.tathata.protocols/render">`render`</a>
``` clojure
...
Given a `pod`, the [`render`](#fogus.tathata.protocols/render) function is expected to produce a
    ...
    appropriate.
<p><sub><a href="https://github.com/fogus/tathata/blob/main/src/clj/fogus/tathata/protocols.clj#L109-L113">Source</a></sub></p>

## <a name="fogus.tathata.protocols/set-ephemeron">`set-ephemeron`</a>
``` clojure
...
<p><sub><a href="https://github.com/fogus/tathata/blob/main/src/clj/fogus/tathata/protocols.clj#L102-L108">Source</a></sub></p>

## <a name="fogus.tathata.protocols/value->mutable">`value->mutable`</a>
``` clojure
...
```
Function.
<p><sub><a href="https://github.com/fogus/tathata/blob/main/src/clj/fogus/tathata/protocols.clj#L27-L27">Source</a></sub></p>
